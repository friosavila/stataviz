...
{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other") cols(3)) msize(3) msymbol(square) mlcolor(black)  total(total)  individual by(agegrp, compact cols(7)) title("Population Composition")"' }}{p_end}
